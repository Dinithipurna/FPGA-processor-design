...
//altiobuf_out CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" ENABLE_BUS_HOLD="FALSE" LEFT_SHIFT_SERIES_TERMINATION_CONTROL="FALSE" NUMBER_OF_CHANNELS=8 OPEN_DRAIN_OUTPUT="FALSE" PSEUDO_DIFFERENTIAL_MODE="FALSE" USE_DIFFERENTIAL_MODE="FALSE" USE_OE="TRUE" USE_TERMINATION_CONTROL="FALSE" datain dataout oe
...
//synthesis_resources = cycloneive_io_obuf 8 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  buffer_iobuf_out_k5t
	( 
	datain,
	dataout,
	oe) ;
...
`endif
	...
	assign
		...
		oe_w = oe;
endmodule //buffer_iobuf_out_k5t
//VALID FILE
...
module buffer (
	...
	buffer_iobuf_out_k5t	buffer_iobuf_out_k5t_component (
				.datain (datain),
				.oe (oe),
				.dataout (sub_wire0));
