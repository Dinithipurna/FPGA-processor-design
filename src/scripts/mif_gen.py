...
with open("DRAM.txt",'r') as file:
    ...
    for x in range(mem_list[1][0]*mem_list[2][0]):
        mem_list.append([np.random.randint(5)])
    for x in range(mem_list[2][0]*mem_list[3][0]):
        temp.append([np.random.randint(5)])
