...
`define FETCH_3 	8'b00000110		//6
`define FETCH_4 	8'b00000111		//7
...
`define LDADDR_3 	8'b00111110		//62
`define LDADDR_4 	8'b00111111		//63
`define LDAC_1 	    8'b01000000		//64
`define LDAC_2 	    8'b01000001		//65
`define LDAC_3 	    8'b01000010		//66
`define LDAC_4 	    8'b01000011		//67
`define LDMULR_1 	8'b01000100		//68
`define LDMULR_2 	8'b01000101		//69
`define LDMULR_3 	8'b01000110		//70
`define LDMULR_4 	8'b01000111		//71
`define LDRP_1 	    8'b01001000		//72
`define LDRP_2 	    8'b01001001		//73
`define LDRP_3 	    8'b01001010		//74
`define LDRP_4 	    8'b01001011		//75
`define LDCP_1 	    8'b01001100		//76
`define LDCP_2 	    8'b01001101		//77
`define LDCP_3 	    8'b01001110		//78
`define LDCP_4 	    8'b01001111		//79
...
`define JMPZ1Y_5	8'b10011011		//153
...
`define JMPZ2Y_5	8'b10100011		//163
`define JMPZ2N_2 	8'b10100010		//162
